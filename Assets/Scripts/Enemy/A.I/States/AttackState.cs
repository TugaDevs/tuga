    ...
    public class AttackState : State
    {
        ...
        private void GetNewAttack(EnemyManager enemyManager)
        {
            ...
            for (int i = 0; i < enemyAttacks.Length; i++)
            {
                ...
                if (distanceFromTarget <= enemyAttackAction.maximumDistanceNeedToAttack && distanceFromTarget >= enemyAttackAction.minimumDistanceNeedToAttack)
                {
        ...
        private void HandleRotateTowardTarget(EnemyManager enemyManager)
        {
            if (enemyManager.isPerformingAction)
            {
                ...
                Quaternion targRotation = Quaternion.LookRotation(direction);
                enemyManager.transform.rotation = Quaternion.Slerp(transform.rotation, targRotation, enemyManager.rotationSpeed / Time.deltaTime);
            }
            else
            {
